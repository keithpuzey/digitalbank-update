    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .slide {
            ...
            transform: scale(1.05); /* Parallax start scale */
        }
        
        .slide.active { 
            opacity: 1; 
            transform: scale(1); /* Parallax end scale */
            z-index: 1;
        }
        ...
        .carousel-nav {
            ...
            z-index: 10;
            pointer-events: none; /* Allows clicks to pass through except to buttons */
        }
        .nav-btn {
        ...
        @media (max-width: 768px) {
            ...
            .carousel-nav { display: none; } /* Better to use swipe on mobile */
        }
    </style>
</head>
<body>
    ...
    <section class="carousel-container" id="mainCarousel">
        <div class="slide active">
            <div class="slide-content">
                ...
                <p>Experience the next generation of financial freedom with global access.</p>
                <a href="/bank/login" class="btn-login">Login</a>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="slide-content">
                ...
                <p>Advanced AI-driven tools designed to help you grow your future today.</p>
        ...
        <div class="slide">
            <div class="slide-content">
                ...
                <p>Rest easy with biometric security and real-time fraud monitoring.</p>
                <a href="/bank/signup" class="btn-login">Open Secure Account</a>
            </div>
        </div>

        <div class="carousel-nav">
            <div class="nav-btn" onclick="moveSlide(-1)">&#10094;</div>
            <div class="nav-btn" onclick="moveSlide(1)">&#10095;</div>
        </div>
    ...
    <script>
        ...
        function openModal() { document.getElementById("demoModal").style.display = "block"; document.body.style.overflow = "hidden"; }
        function closeModal() { document.getElementById("demoModal").style.display = "none"; document.body.style.overflow = "auto"; }
        ...
        let touchStartX = 0;
        let touchEndX = 0;
        const carouselArea = document.getElementById('mainCarousel');
